...
1. Refactor the monstrous code in the `gildedrose.go` class.
2. Add a new item type, "Conjured". The specs for this item are commented out in the `gildedrose_test.go` file.
